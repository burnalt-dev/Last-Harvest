...
**Last Harvest:** always open `.grok/skills/last-harvest/SKILL.md` first on every turn that touches this game, then one sister skill. Chat (Ivan) beats the skill. Do not wipe `src/game` (31A).

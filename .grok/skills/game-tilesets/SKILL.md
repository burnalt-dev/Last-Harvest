...
**Last Harvest:** open `last-harvest` then **`last-harvest-makers`**. Forest tiles are **2:1 iso diamonds** (`last-harvest-terrain`), not seamless top-down squares. Do not 3D the floor. Crate is 3D Bay, not a tile.

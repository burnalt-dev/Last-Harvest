...
**Last Harvest:** open `last-harvest` then **`last-harvest-makers`**. Do **not** video-harvest Solace crate walks. Crate motion is 3D (`solace-mech-anim`). Terrain stays 2D stills. Gasket and foes are 3D meshes.

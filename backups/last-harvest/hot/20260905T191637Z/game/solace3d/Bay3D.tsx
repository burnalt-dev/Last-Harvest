...
import { buildWanzer, clampKit, cycleHands, GOLD_GREY, GOLD_REV, GOLD_SIT, KIT_NAMES, plantY, setBonesVisible, setSeatGizmoVisible, type GoldSit, type Kit, type KitSlot } from "./kit";

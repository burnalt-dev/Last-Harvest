...
export function equipWeapon(loadout: Loadout, stance: Stance): Loadout {
  if (stance === "twohand") return { ...loadout, handL: "p018", handR: "p018" };
  if (stance === "lancer") return { ...loadout, handL: "p007", handR: "p010" };
  if (stance === "lancers") return { ...loadout, handL: "p010", handR: "p010", body: "p020" };
  if (stance === "sawlance") return { ...loadout, handL: "p010", handR: "p008" };

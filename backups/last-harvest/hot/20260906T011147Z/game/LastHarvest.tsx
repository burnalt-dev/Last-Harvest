...
import { DIFFICULTY, statsOf, type Difficulty } from "./data";
          ...
          <div className="absolute inset-0 z-30 flex items-center justify-center bg-black/50 p-3" onClick={() => setMenu(null)}>
            <div className="menu-slate" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="mt-3 grid gap-2">
                ...
                <Plate qa="gasket-focus" onClick={() => void loadPlay().then((p) => { p.setGasketMode(dungeon, "focus"); setDungeon({ ...dungeon }); })}>Focus</Plate>

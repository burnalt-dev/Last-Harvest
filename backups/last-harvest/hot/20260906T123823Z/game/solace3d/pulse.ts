...
export function makePinMark() {
  ...
  const ring = new THREE.Mesh(
    new THREE.TorusGeometry(0.12, 0.024, 8, 20),
  ...
  const pillar = new THREE.Mesh(
    new THREE.CylinderGeometry(0.022, 0.04, 0.5, 8),
    new THREE.MeshBasicMaterial({ color: 0x7af8ea, transparent: true, opacity: 0.85, depthWrite: false }),
  );

...
import { enterAim, exitAim, shootCannon, type Dungeon, type Enemy, type Fx } from "../sim";
...
/** Shoot = drop shootCannon, no dungeon tickRound (Nest keeps its own round). One primary only. */

...
export function buildWanzer(kit: Kit, sit: GoldSit = GOLD_SIT): WanzerRig {
  ...
  if (rKind === "scythe" || rKind === "saw") {
    wpnSlotR.add(buildGripper(1, rKind === "scythe" ? "pole" : "hilt"));
  }
  if (rKind === "scythe") {
    wpnSlotL.add(buildGripper(-1, "pole"));
  } else if (lKind === "shield") {
    wpnSlotL.add(buildGripper(-1, "slab"));
  }

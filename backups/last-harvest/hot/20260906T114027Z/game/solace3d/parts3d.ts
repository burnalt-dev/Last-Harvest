...
function buildCannon(sit: GoldSit, _side: 1 | -1 = 1): THREE.Group {
  ...
  tip.name = "muzzle_tip";
  tip.position.y = len * 1.02;
  gun.add(tip);
  g.add(gun);
  return g;
}

export function cannonMuzzles(root: THREE.Object3D): { R: THREE.Object3D | null; L: THREE.Object3D | null } {
  const found: { R: THREE.Object3D | null; L: THREE.Object3D | null } = { R: null, L: null };
  root.traverse((o) => {
    if (o.name !== "muzzle_tip") return;

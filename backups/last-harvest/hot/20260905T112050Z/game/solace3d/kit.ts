...
export function buildWanzer(kit: Kit, sit: GoldSit = GOLD_SIT): WanzerRig {
  ...
  const rest = {
    ...
    zL: lKind === "cannon" ? 0.22 : 0,
    zR: rKind === "cannon" ? -0.22 : 0,
  };
  ...
  if (lKind === "shield") {
    armL.forearm.rotation.y = 0.65;
    armL.wrist.rotation.z = 0.12;
  }
  if (rKind === "saw") armR.wrist.rotation.z = 0.18;
  if (rKind === "scythe") armR.wrist.rotation.z = -0.12;

...
import { buildWanzer, clampKit, cloneSit, cycleHands, dumpHoldProfiles, GOLD_GREY, GOLD_REV, GOLD_SIT, HOLD_IDS, holdId, KIT_NAMES, plantY, setBonesVisible, setSeatGizmoVisible, type GoldSit, type HoldId, type HoldProfile, type Kit, type KitSlot } from "./kit";

...
export function buildWanzer(kit: Kit, sit: GoldSit = GOLD_SIT): WanzerRig {
  ...
  let swinging = false;
  const armed = rKind === "scythe";
  const rest = {
    chestX: 0,
    upperL: armed ? 0.58 : lKind === "cannon" ? 0.22 : lKind === "shield" ? 0.48 : 0.35,
    upperR: armed ? 0.55 : rKind === "cannon" ? 0.18 : rKind === "saw" ? 0.42 : 0.35,
    elbowL: armed ? 0.72 : lKind === "cannon" ? 0.28 : lKind === "shield" ? 0.58 : 0.4,
    elbowR: armed ? 0.78 : rKind === "cannon" ? 0.22 : rKind === "saw" ? 0.52 : 0.4,
  };
  ...
  if (rKind === "cannon") armR.wrist.rotation.x = -0.38;
  if (lKind === "cannon") armL.wrist.rotation.x = -0.38;
  if (lKind === "shield") armL.forearm.rotation.y = 0.35;
